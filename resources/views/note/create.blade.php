<x-layout>
    <div class="h-[60svh] flex justify-center items-center w-[80vw] ml-[10vw]">
        <form class="w-full mx-auto" action="{{ route('note.store') }}" method="POST">
            @csrf
            <div class="mb-5">
            ...
            <div class="mb-5">
                <label for="note" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sua nota</label>
